...
class Tracking(object):
    ...
    def track(self, img, frame_id, timestamp=None):
        ...
        with self.map.update_lock:
            ...
            # update ground truth and estimated trajectory history
            ...
            self.update_history()
            # Print time history of estimated trajectory
            # print('traj3d_est: ', self.traj3d_est)
            # Print gt trajectory
            # print('traj3d_gt: ', self.traj3d_gt)
